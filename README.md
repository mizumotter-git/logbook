...
- **7 switchable themes** — no safe palette swaps: each one commits hard to a single world, with its own typography, card layout, background scenery, and motion. Two of them come with a resident animal. See [Themes](#themes) below.
...
| **editorial** — paper and ink: square corners, marquee ticker, one Klein-blue accent ![editorial theme](assets/themes/editorial.jpg) | **ocean** — a clear midsummer sea: rolling surf, sun glitter on the water, a little sailboat drifting by ![ocean theme](assets/themes/ocean.jpg) |
